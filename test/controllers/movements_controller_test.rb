...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { description: @movement.description, text: @movement.text, user_id: @movement.user_id } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { description: @movement.description, text: @movement.text, user_id: @movement.user_id } }
